...
<template>
  <transition name="slide-in-up">
    <div
      v-if="modelValue"
      class="flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 justify-center items-center"
    >
      <div
        ref="rModal"
  ...
  <div
    v-if="modelValue"
    class="opacity-25 fixed inset-0 z-40 bg-black transition transition-all duration-300"
  ></div>
</template>
